...
const NavBar = () => {
    ...
    // Example: role can be 'admin' or 'patient'
    const role = localStorage.getItem("role");

    const handleProfile = () => navigate("/profile");
    const handleLogout = () => navigate("/");
    const handleHome = () => navigate("/home");
    const handleRecords = () => navigate("/patient");
    const handleDoctor = () => navigate("/doctors");
        ...
        <>
            ...
            <nav className="navbar navbar-expand-lg navbar-dark bg-primary">
                <div className="container-fluid">
                    {/* Brand Logo */}
                    <a className="navbar-brand fw-bold" href="#" onClick={handleHome}>
                    ...
                    <div className="collapse navbar-collapse">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item">
                                <a className="nav-link" href="#" onClick={handleAppointments}>Appointments</a>
                            </li>

                            {/* Conditionally show Patient Records */}
                            {role === "admin" && (
                                <li className="nav-item">
            ...
            >
                ...
                <div className="offcanvas-body">
                    <ul className="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <li className="nav-item">
                            <a className="nav-link" href="#" onClick={handleAppointments}>
                        ...
                        {role === "admin" && (
                            <li className="nav-item">
                                <a className="nav-link" href="#" onClick={handleRecords}>
                        ...
                        <li className="nav-item">
                            <a className="nav-link" href="#" onClick={handleDoctor}>
